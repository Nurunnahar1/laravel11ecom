        ...
        <div class="main-content-inner">
            ...
            <div class="main-content-wrap">
                ...
                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                    action="{{ route('admin.product.update', $products->slug) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="wg-box">
                        <fieldset>
                            ...
                            <div class="upload-image flex-grow">
                                ...
                                <div class="mb-3">
                                    <img class="" id="newImg" width="150" src="{{ asset($products->image) }}">
                                </div>
                        ...
                        <fieldset>
                            ...
                            {{-- <div class="upload-image mb-16">
                                <div id="galUpload" class="item up-load">
                                    ...
                                    <img id="imagePreviews" class="image-preview-container"
                                        src="{{ asset($products->images) }}" />
                                </div>
                                ...
                                <div id="galUpload" class="item up-load">
                                    @if (!empty($product->images))
                                        @foreach ($product->images as $photos)
                                            <img src="{{ asset($photos) }}" class="gallery-image-preview" width="150"
                            ...
                            <fieldset class="name">
                                ...
                                <div class="select mb-10">
                                    <select class="" name="stock_status">
                                        <option value="instock" @if ($products->stock_status == 'instock') selected @endif>In Stock
                                        </option>
                                        <option value="outofstock" @if ($products->stock_status == 'outofstock') selected @endif>Out of
                                            Stock</option>
                                    </select>
                                </div>
                            </fieldset>
                            <fieldset class="name">
                                ...
                                <div class="select mb-10">
                                    <select class="" name="featured">
                                        <option value="0" @if ($products->featured == 0) selected @endif>No
                                        </option>
                                        <option value="1" @if ($products->featured == 1) selected @endif>Yes
                                        </option>
                                    </select>
                                </div>
                            </fieldset>
