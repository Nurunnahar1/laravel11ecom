    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="main-content-wrap">
                ...
                <!-- new-category -->
                <div class="wg-box">
                    <form class="form-new-product form-style-1" action="{{ route('admin.category.update', $categories->slug) }}" method="POST"
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('name') is-invalid @enderror" type="text"
                                placeholder="Brand name" name="name" tabindex="0" value="{{ $categories->name }}"
                        ...
                        <fieldset>
                           ...
                           <div class="mb-3">
                             ...
                             <div class="mb-3">
                                <img class="" id="newImg" width="150" src="{{ asset($categories->image ?? '') }}">
                            </div>
                        </fieldset>
